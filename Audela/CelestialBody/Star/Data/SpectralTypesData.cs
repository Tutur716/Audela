...
using System.Linq;
using System.Text;
using st = Audela.CelestialBody.Star.Data.SpectralTypes;
using lt = Audela.CelestialBody.Star.Data.LuminosityTypes;

namespace Audela.CelestialBody.Star.Data
{
    /// <summary>
    ...
    static class SpectralTypesData
    {
        ...
        static public double RandomRadius(st SpectralType, lt LuminosityType)
        {
            ...
            return (r.NextDouble() * (max - min) + min) * UsefulValues.SunRadius * 1000;
        }
        #endregion
        ...
        static public double RandomMass(st SpectralType, lt LuminosityType)
        {
            ...
            return (r.NextDouble() * (max - min) + min) * UsefulValues.SunMass * 1000;
        }
        #endregion

        /// <summary>
        /// Get the max Semi-Major-Axis for Planets in meters
        /// </summary>
        static public double GetMaxSMA(st SpectralType, lt LuminosityType)
        {
            double d = 0;
            switch (LuminosityType)
            {
